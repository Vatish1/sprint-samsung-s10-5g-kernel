...
#define MFC_FW_BIN_LSI_VERSION			0x1002
#define MFC_FLASH_FW_HEX_LSI_PATH		"mfc/mfc_fw_flash_s2miw04_lsi.bin"
...
static const u16 mfc_lsi_vout_val16[] = {
 0x0088, 0x00A1, 0x00BA, 0x00EC, 0x011E, 0x0150, 0x0182,
};
...
enum mfc_chip_id {
	MFC_CHIP_IDT = 0,
	MFC_CHIP_LSI,
	MFC_CHIP_LSI_S2MIW04,
};

#define is_IDT_chip(mfc_chip_id) ( \
	mfc_chip_id == MFC_CHIP_IDT)

#define is_LSI_chip(mfc_chip_id) ( \
	mfc_chip_id == MFC_CHIP_LSI || \
	mfc_chip_id == MFC_CHIP_LSI_S2MIW04)
