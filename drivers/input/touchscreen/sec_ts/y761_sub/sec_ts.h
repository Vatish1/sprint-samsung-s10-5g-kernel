...
#define SEC_TS_CMD_SET_POWER_SLEEP_MODE	0xE0
...
/* qeexo earsensor data*/
#undef QEEXO_EAR_SENSE
#ifdef QEEXO_EAR_SENSE
#define EAR_DATA_READ_LENGTH  800	// (rx/2) * tx * 2
#define HOVER_DATA_READ_LENGTH 150	// (rx+tx) * 2

#define SEC_TS_SET_ES_ENABLE	0xEA
#define SEC_TS_READ_PROXIMITY_MUTU_DATA	0x9C
#define SEC_TS_READ_PROXIMITY_RAW_DATA	0x9D
#define SEC_TS_READ_PROXIMITY_HOVER_SELF_DATA	0x9E
#define SEC_TS_SET_VALUE_MUTU_DATA	40
#define SEC_TS_SET_VALUE_SELF_DATA	5

static unsigned char ear_data[EAR_DATA_READ_LENGTH] = { 0 };
static unsigned char hover_data[HOVER_DATA_READ_LENGTH] = { 0 };
#endif
...
struct sec_ts_data {
	...
	u8 es_enable;
	bool read_ear_data;
	struct delayed_work qeexo_read_ear_data;
#endif
	...
	short cm_raw_set_p2p_min;
	short cm_raw_set_p2p_max;
	short cm_raw_set_p2p_diff;
	
	short self_raw_set_p2p_x_min;
	short self_raw_set_p2p_x_max;
	short self_raw_set_p2p_y_min;
	short self_raw_set_p2p_y_max;
	short self_raw_set_p2p_x_diff;
	short self_raw_set_p2p_y_diff;
...
#ifdef QEEXO_EAR_SENSE
int sec_ts_es_read_delta(struct sec_ts_data *ts);
#endif
